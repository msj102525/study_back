...
<nav>
	<ul id="menubar">
		<li><a href="${ pageContext.servletContext.contextPath }/main.do">Home</a></li>
		<li><a href="${ pageContext.servletContext.contextPath }/nlist.do?page=1">공지사항 관리</a></li>
		<li><a href="${ pageContext.servletContext.contextPath }/blist.do?page=1">게시글 관리</a></li>
