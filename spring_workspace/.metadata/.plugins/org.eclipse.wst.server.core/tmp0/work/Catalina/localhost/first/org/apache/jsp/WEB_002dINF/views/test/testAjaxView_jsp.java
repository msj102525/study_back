 ...
 * Generated at: 2024-03-28 03:34:58 UTC
...
public final class testAjaxView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	//$('selector').method(..).method(..).method(..);\r\n");
      out.write("	$('#test1').click(function(){\r\n");
      out.write("		//서버측 컨트롤러로 서비스 요청하고, 결과로 문자열을 받는 경우에는\r\n");
      out.write("		//$.get('요청url', {전송이름 : 전송값}, function(data){ 요청 성공시 리턴값 받는 함수 })\r\n");
      out.write("		\r\n");
      out.write("		//get 사용\r\n");
      ...
      out.write("<hr>\r\n");
      out.write("\r\n");
      out.write("<h2>2. 서버로 전송하는 값은 있고, 결과로 문자열을 받아서 출력 : post 방식</h2>\r\n");
      ...
      out.write("		//서버측 컨트롤러로 서비스 요청하고, 결과로 문자열을 받는 경우에는\r\n");
      out.write("		//$.post('요청url', {전송이름 : 전송값}, function(data){ 요청 성공시 리턴값 받는 함수 })\r\n");
      out.write("		\r\n");
      out.write("		//post 사용\r\n");
      out.write("		$.post(\"test2.do\", \r\n");
      out.write("				{name: $('#name').val() , age: $('#age').val() }, \r\n");
      ...
      out.write("			type: \"post\",\r\n");
      out.write("			dataType: \"json\",   //\"json\" 는 post 로 지정함\r\n");
      out.write("			success: function(data){\r\n");
      out.write("				//json 객체 한 개를 받을때는 바로 출력할 수 있음\r\n");
      out.write("				console.log(\"json data : \" + data);\r\n");
      out.write("				\r\n");
      out.write("				//응답온 값에 인코딩된 문자가 있으면, 자바스크립트가 제공하는\r\n");
      out.write("				//decodeURIComponent(응답값) 함수 사용해서 반드시 디코딩 처리해야 함\r\n");
      ...
      out.write("						+ \"<br>제목 : \" \r\n");
      out.write("						+ decodeURIComponent(data.noticetitle).replace(/\\+/gi, ' ')\r\n");
      out.write("						+ \"<br>작성자 : \" + data.noticewriter\r\n");
      out.write("						+ \"<br>날짜 : \" + data.noticedate\r\n");
      out.write("						+ \"<br>내용 : \"\r\n");
      out.write("						+ decodeURIComponent(data.noticecontent).replace(/\\+/gi, ' '));\r\n");
      out.write("			}, \r\n");
      ...
      out.write("<div id=\"p4\" style=\"width:400px;height:400px;border:1px solid red;\">\r\n");
      ...
      out.write("			type: 'post', //json 을 받을때는 post 로 지정함\r\n");
      ...
      out.write("				console.log('dataObj : ' + dataObj);  //[object, Object]\r\n");
      out.write("				\r\n");
      ...
      out.write("				//json 객체 안의 list 를 하나씩 꺼내서 새로운 행으로 추가 처리\r\n");
      ...
      out.write("\" readonly>\r\n");
      out.write("		<br>\r\n");
      out.write("		내용 : <textarea rows=\"5\" cols=\"30\" id=\"content\"></textarea>\r\n");
      out.write("	</fieldset>\r\n");
      out.write("</div>\r\n");
      ...
      out.write("		job.writer = document.getElementById('writer').value;\r\n");
      ...
      out.write("\" readonly>\r\n");
      out.write("		<br>\r\n");
      out.write("		내용 : <textarea rows=\"5\" cols=\"30\" id=\"ncontent\"></textarea>\r\n");
      out.write("	</fieldset>\r\n");
      ...
      out.write("	//jarr2.push({name: '홍길순', age: 25});\r\n");
      out.write("	\r\n");
      out.write("	//배열 초기화\r\n");
      out.write("	/*\r\n");
      out.write("		var jarr3 = [{name: '홍길동', age: 30}, \r\n");
      out.write("					{name: '홍길순', age: 27}, \r\n");
      out.write("					{name: '이순신', age: 45}];\r\n");
      out.write("	*/\r\n");
      out.write("	\r\n");
      ...
      out.write("	//p6 태그 영역에 json string 을 추가 기록 처리함\r\n");
      ...
      out.write("		\r\n");
      out.write("		//기존 기록된 input 의 값은 지우기\r\n");
      ...
      out.write("	\r\n");
      out.write("	//body 의 form 태그 객체 생성함\r\n");
      ...
      out.write("		processData: false,  //multipart 전송은 false 로 지정\r\n");
      out.write("		contentType: false,  //multipart 전송은 false 로 지정\r\n");
      out.write("		type: 'post',\r\n");
      out.write("		data: formData,\r\n");
      out.write("		success: function(data, jqXHR, textStatus){\r\n");
      ...
      out.write("	//javascript ajax() 로 파일업로드용 form 전송 처리\r\n");
      out.write("	\r\n");
      ...
      out.write("<hr>\r\n");
      out.write("\r\n");
      out.write("<h2>8. ajax 로 파일다운로드</h2>\r\n");
      out.write("<h3>jQuery 기반 ajax 이용 파일다운로드</h3>\r\n");
      out.write("<a id=\"fdown\" onclick=\"fileDown();\">sample.txt</a>\r\n");
      out.write("<br><br>\r\n");
      out.write("\r\n");
      out.write("<h3>javascript 기반 ajax 이용 파일다운로드</h3>\r\n");
      out.write("<a id=\"fdown2\" onclick=\"fileDown2();\">sample.txt</a>\r\n");
      out.write("<br><br>\r\n");
      out.write("\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("function fileDown(){\r\n");
      out.write("	console.log(\"Aaaaaa!\");\r\n");
      out.write("	//jQuery ajax 로 파일다운로드 처리\r\n");
      out.write("	//a 태그(다운받을 파일명)을 클릭하면 서버로 다운로드 요청함\r\n");
      out.write("	\r\n");
      ...
      out.write("	//javascript ajax 로 파일다운로드 처리\r\n");
      out.write("	//a 태그(다운받을 파일명)을 클릭하면 서버로 다운로드 요청함\r\n");
      out.write("	\r\n");
      ...
      out.write("		link.click();\r\n");
      out.write("	}else{\r\n");
      out.write("		//브라우저에 ajax 처리용 객체가 제공되는 않는다면\r\n");
