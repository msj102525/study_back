...
<script>
	...
	Kakao.init('afe6e5daf5dbbaa2d0c424a853366481');
...
<body>
	...
	<a href="https://kauth.kakao.com/oauth/authorize?client_id=afe6e5daf5dbbaa2d0c424a853366481&redirect_uri=http://localhost:8080/first/kakao_login.do&response_type=code">	
		<img src="/first/resources/images/kakao_login.png">
	</a> 
	</center>
	<center>	
	...
	<a href="https://accounts.kakao.com/login?continue=https://kauth.kakao.com/oauth/authorize&response_type=code&redirect_uri=http://localhost:8080/first/kakao_login.do&client_id=afe6e5daf5dbbaa2d0c424a853366481">	
		<img src="/first/resources/images/kakao_login.png">
	</a> 
	</center>
<hr>
