...
<body>
	...
	<form action="enroll.do" id="enrollForm" method="post" onsubmit="return validate();x`">
		<table id="outer" align="center" width="700" cellspacing="5" cellpadding="0">
			<tr>
				<th colspan="3">회원 정보를 입력해 주세요. (* 표시는 필수입력 항목입니다.)</th>
			</tr>
			<tr>
				<th width="120">*아이디</th>
				<td><input type="text" name="userId" id="userid" required> &nbsp; <input type="button" value="중복체크" onclick="return dupIDCheck();"></td>
				<td rowspan="7" width="180" align="center" valign="middle">
					<div id="myphoto" style="margin: 0; width: 150px; height: 160px; padding: 0; border: 1px solid navy;">
						<img src="/first/resources/images/channels4_profile.jpg" id="photo" style="width: 150px; height: 160px; border: 1px solid navy; display: block;" alt="사진을 드래그 드롭하세요." style="padding:0;margin:0;"><br>
					</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<th>기타 정보(연습용)</th>
				<td colspan="2"><textarea name="etc" rows="3" cols="50"></textarea></td>
			</tr>
			<tr>
				<th colspan="3"><input type="submit" value="가입하기"> &nbsp; 
