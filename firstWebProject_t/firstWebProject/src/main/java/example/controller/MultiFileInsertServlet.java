...
/**
 * Servlet implementation class MultiFileInsertServlet
 */
@WebServlet("/multiinsert")
public class MultiFileInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public MultiFileInsertServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String savePath = request.getSession().getServletContext().getRealPath("/resources/example_files");
