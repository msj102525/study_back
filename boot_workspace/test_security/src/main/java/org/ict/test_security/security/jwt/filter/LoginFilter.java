...
import org.ict.test_security.security.jwt.model.service.RefreshService;
...
public class LoginFilter extends UsernamePasswordAuthenticationFilter {
    private final Long accessExpiredMs;  // access Token 만료일 (ms)
    private final Long refreshExpiredMs;  // refresh Token 만료일 (ms)
    ...
    public LoginFilter(MemberService memberService, RefreshService refreshService, AuthenticationManager authenticationManager,
                JWTUtil jwtUtil) {
        ...
        this.refreshExpiredMs = 1000 * 60 * 60 * 24L; // 24시간
    }
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        Optional<User> userOptional = memberService.findByEmail(username);
