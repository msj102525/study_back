...
import org.ict.test_security.security.handler.CustomLogoutHandler;
import org.ict.test_security.security.jwt.filter.JWTFilter;
import org.ict.test_security.security.jwt.filter.LoginFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                // JWTFilter 와 LoginFilter를 필터 체인에 등록함
