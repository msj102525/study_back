...
public class QRefreshToken extends EntityPathBase<RefreshToken> {
    ...
    private static final long serialVersionUID = -1105099040L;
    ...
    public final org.ict.test_security.member.jpa.entity.QMemberEntity memberDto;
    ...
    public QRefreshToken(Class<? extends RefreshToken> type, PathMetadata metadata, PathInits inits) {
        ...
        this.memberDto = inits.isInitialized("memberDto") ? new org.ict.test_security.member.jpa.entity.QMemberEntity(forProperty("memberDto")) : null;
    }
