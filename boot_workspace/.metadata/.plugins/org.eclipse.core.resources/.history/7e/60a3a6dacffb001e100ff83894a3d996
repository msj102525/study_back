...
<h4><a href="${ pageContext.servletContext.contextPath }/moveExam01.do">1. div 에 지도 표시하기</a></h4>
<h4><a href="${ pageContext.servletContext.contextPath }/moveExam02.do">2. 내 위치 지도에 표시하기</a></h4>
<h4><a href="${ pageContext.servletContext.contextPath }/moveExam03.do">3. 지도에 위치 마커 표시하기</a></h4>
<h4><a href="${ pageContext.servletContext.contextPath }/moveExam04.do">4. 지도 마커에 정보창 표시하기</a></h4>
<h4><a href="${ pageContext.servletContext.contextPath }/moveExam05.do">5. 지도에 마커 여러 개 표시하기</a></h4>

<h4><a href="positions.do">6. 지도에 마커 여러 개 표시하기(컨트롤러 연결 처리)</a></h4>
</body>
</html>
