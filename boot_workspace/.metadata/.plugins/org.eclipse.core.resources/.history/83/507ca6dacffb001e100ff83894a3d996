...
<script>
	...
	Kakao.init('10a4f5ddc6296d7f583750f16a795394');
...
<body>
	...
	<a href="https://kauth.kakao.com/oauth/authorize?client_id=10a4f5ddc6296d7f583750f16a795394&redirect_uri=http://localhost:8080/first/kakao_login.do&response_type=code">	
		<img src="/first/resources/images/kakao_login.png">
	</a> 
	</center>
	<center>	
	...
	<a href="https://accounts.kakao.com/login?continue=https://kauth.kakao.com/oauth/authorize&response_type=code&redirect_uri=http://localhost:8080/first/kakao_login.do&client_id=10a4f5ddc6296d7f583750f16a795394">	
		<img src="/first/resources/images/kakao_login.png">
	</a> 
	</center>
<hr>
...
<br>
에를 들면, http://localhost:8080/first/login<br>
