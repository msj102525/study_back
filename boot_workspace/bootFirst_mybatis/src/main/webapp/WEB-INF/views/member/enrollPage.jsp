...
function dupIDCheck(){
	...
	$.ajax({
		url: "${ pageContext.servletContext.contextPath }/idchk.do",
		type: "post",
...
<form action="${ pageContext.servletContext.contextPath }/enroll.do" id="enrollForm" method="post" onsubmit="return validate():">
<table id="outer" align="center" width="700" cellspacing="5" cellpadding="0">
	...
	<tr><th width="120">*아이디</th>
		...
		<td rowspan="7" width="180" align="center" valign="middle">
			...
			style="margin:0;width:150px;height:160px;padding:0;border:1px solid navy;">
				<img src="${ pageContext.servletContext.contextPath }/resources/member_photofiles/preview.jpg" id="photo" 				
	...
	<td align="right"><input type="file" name="photoFileName" id="photofile" value=""></td>
	</tr>
	<tr><th>취미(연습용)</th>
	<td colspan="2">
		<table width="350">
