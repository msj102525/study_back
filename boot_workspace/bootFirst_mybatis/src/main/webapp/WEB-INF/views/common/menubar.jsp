...
<nav>
	...
	<!-- 스프링에서의 절대경로 표기 : 
	 ...
	 -->
		...
		<li><a href="${ pageContext.servletContext.contextPath }/moveAOP.do">ㅇㅇㅇ</a></li>
		<li><a href="${ pageContext.servletContext.contextPath }/moveAjax.do">ㅇㅇㅇ</a></li>
		<li><a href="${ pageContext.servletContext.contextPath }/moveCrawling.do">ㅇㅇㅇ</a></li>
		<li><a href="${ pageContext.servletContext.contextPath }/views/testapi/testList.html">ㅇㅇㅇ</a></li>
		<li><a href="${ pageContext.servletContext.contextPath }/views/example/sampleList.html">ㅇㅇㅇ</a></li>
	</ul>
</nav>
</c:if>
...
<nav>
	<ul id="menubar">
		...
		<li><a href="${ pageContext.servletContext.contextPath }/WEB-INF/views/testapi/testList.html">ㅇㅇㅇ</a></li>
		<li><a href="${ pageContext.servletContext.contextPath }/WEB-INF/views/example/sampleList.html">ㅇㅇㅇ</a></li>
	</ul>
</nav>
</c:if>
<%-- <% }else{ //일반회원이 로그인 했을 때 %> --%>
...
<nav>
	<ul id="menubar">
		...
		<li><a href="${ pageContext.servletContext.contextPath }/blist.do">게시글</a></li>
		<li><a href="${ pageContext.servletContext.contextPath }/moveAOP.do">ㅇㅇㅇ</a></li>
		<li><a href="${ pageContext.servletContext.contextPath }/moveAjax.do">ㅇㅇㅇ</a></li>
		<li><a href="${ pageContext.servletContext.contextPath }/views/testapi/testList.html">ㅇㅇㅇ</a></li>
		<li><a href="${ pageContext.servletContext.contextPath }/views/example/sampleList.html">ㅇㅇㅇ</a></li>
