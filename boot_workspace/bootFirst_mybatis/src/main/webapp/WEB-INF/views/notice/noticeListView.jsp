...
<%-- 제목 검색 폼 --%>
<form id="titleform" class="sform" action="${ pageContext.servletContext.contextPath }/nsearchTitle.do" method="post">
...
<%-- 내용 검색 폼 --%>
<form id="contentform" class="sform" action="${ pageContext.servletContext.contextPath }/nsearchContent.do" method="post">
...
<%-- 등록날짜 검색 폼 --%>
<form id="dateform" class="sform" action="${ pageContext.servletContext.contextPath }/nsearchDate.do" method="post">
...
<tr>
	...
	<td><a href="${ pageContext.servletContext.contextPath }/ndetail.do?noticeno=${ n.noticeNo }">
