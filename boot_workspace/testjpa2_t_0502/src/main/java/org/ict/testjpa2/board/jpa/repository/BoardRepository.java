...
//JPA 의 Repository 는 JpaRepository 를 상속받아서 만듦
...
public interface BoardRepository  extends JpaRepository<BoardEntity, Integer> {
  ...
  @Query(value = "SELECT b FROM BoardEntity b WHERE b.boardDate BETWEEN :begin AND :end",
   ...
   Page<BoardEntity> findSearchDate(@Param("begin") java.sql.Date begin,
                                                             @Param("end") java.sql.Date end, @Param("pageable") Pageable pageable);
